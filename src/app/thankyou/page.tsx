      ...
      <div className="max-w-4xl w-full reveal animate-fade-in-up">
        ...
        <div className="text-center mb-16">
          <div className="relative inline-block">
            <div
              className="w-28 h-28 rounded-3xl flex items-center justify-center mx-auto mb-10 animate-float"
              style={{
        ...
        <div className="glass-card p-8 md:p-16 shadow-2xl flex flex-col gap-12 relative overflow-hidden mb-12">
          <div className="flex flex-col gap-10">
            <h2 className="text-xl font-bold text-white uppercase tracking-widest text-center opacity-50">Submission summary</h2>
        ...
        {(submission?.tabSwitchCount ?? 0) + (submission?.fullscreenExitCount ?? 0) > 0 && (
          <div className="glass-card p-6 mb-12 border-amber-500/20 bg-amber-950/10">
            <p className="text-amber-300 text-sm font-semibold mb-3">Violations Recorded</p>
